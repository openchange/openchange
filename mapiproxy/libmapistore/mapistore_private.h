...
enum mapistore_error mapistore_backend_folder_move_folder(struct backend_context *, void *, void *, uint64_t, const char *);
enum mapistore_error mapistore_backend_folder_copy_folder(struct backend_context *, void *, void *, uint64_t, bool, const char *);
