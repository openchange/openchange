...
struct mapistore_backend {
	...
	struct {
		...
		int		(*delete_message)(void *, uint64_t, uint8_t flags);
	        int		(*move_copy_messages)(void *, uint32_t, uint64_t *, void *, uint64_t *, uint8_t);
...
int mapistore_folder_move_copy_messages(struct mapistore_context *, uint32_t, void *, uint32_t, uint64_t *, void *, uint64_t *, uint8_t);
