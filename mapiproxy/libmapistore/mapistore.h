...
struct indexing_context {
	...
	enum mapistore_error	(*allocate_fmids)(struct indexing_context *, const char *, int, int64_t *);
...
struct mapistore_backend {
	...
	struct {
		...
		enum mapistore_error	(*get_deleted_fmids)(void *, TALLOC_CTX *, enum mapistore_table_type, uint64_t, struct UI8Array_r **, int64_t *);
...
int mapistore_getprops(struct mapistore_context *, uint32_t, TALLOC_CTX *, int64_t, uint8_t, struct SPropTagArray *, struct SRow *);
int mapistore_setprops(struct mapistore_context *, uint32_t, int64_t, uint8_t, struct SRow *);
...
enum mapistore_error mapistore_folder_get_deleted_fmids(struct mapistore_context *, uint32_t, void *, TALLOC_CTX *, enum mapistore_table_type, uint64_t, struct UI8Array_r **, int64_t *);
...
enum mapistore_error mapistore_message_attachment_open_embedded_message(struct mapistore_context *, uint32_t, void *, TALLOC_CTX *, void **, int64_t *, struct mapistore_message **msg);
...
enum mapistore_error mapistore_indexing_reserve_fmid_range(struct mapistore_context *, uint64_t, int64_t *);
...
struct mapistore_table_subscription_parameters {
	uint8_t table_type;
	int64_t folder_id; /* the parent folder id */
};
...
struct mapistore_table_notification_parameters {
	...
	uint32_t handle;
	int64_t folder_id; /* the parent folder id */
	int64_t object_id; /* the folder/message id */
...
struct mapistore_object_notification_parameters {
	int64_t folder_id;      /* the parent folder id */
	int64_t object_id;      /* the folder/message id */
        int64_t old_folder_id;  /* used for copy/move notifications */
        int64_t old_object_id;  /* used for copy/move notifications */
	uint16_t tag_count;
	enum MAPITAGS *tags;
