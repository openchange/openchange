...
struct openchangedb_context {
	...
	enum MAPISTATUS (*reserve_fmid_range)(struct openchangedb_context *, uint64_t, uint64_t *);
	...
	enum MAPISTATUS (*get_mailboxDN)(TALLOC_CTX *, struct openchangedb_context *, uint64_t, char **);
	...
	enum MAPISTATUS (*get_mapistoreURI)(TALLOC_CTX *, struct openchangedb_context *, uint64_t, char **, bool);
	enum MAPISTATUS (*set_mapistoreURI)(struct openchangedb_context *, uint64_t, const char *, bool);
	...
	enum MAPISTATUS (*set_folder_properties)(struct openchangedb_context *, uint64_t, struct SRow *);
	enum MAPISTATUS (*get_folder_property)(TALLOC_CTX *, struct openchangedb_context *, uint32_t, uint64_t, void **);
	enum MAPISTATUS (*get_folder_count)(struct openchangedb_context *, uint64_t, uint32_t *);
	enum MAPISTATUS (*get_message_count)(struct openchangedb_context *, uint64_t, uint32_t *, bool);
	enum MAPISTATUS (*get_system_idx)(struct openchangedb_context *, uint64_t, int *);
	enum MAPISTATUS (*get_table_property)(TALLOC_CTX *, struct openchangedb_context *, const char *, uint32_t, uint32_t, void **);
	enum MAPISTATUS (*get_fid_by_name)(struct openchangedb_context *, uint64_t, const char*, uint64_t *);
	enum MAPISTATUS (*get_mid_by_subject)(struct openchangedb_context *, uint64_t, const char *, bool, uint64_t *);
	...
	enum MAPISTATUS (*create_folder)(struct openchangedb_context *, uint64_t, uint64_t, uint64_t, const char *, int);
	enum MAPISTATUS (*delete_folder)(struct openchangedb_context *, uint64_t);
