...
#
# This work is a derivative of python/samba/netcmd/__init__.py from
# the Samba project
#
...
class Command(object):
    ...
    def show_command_error(self, e):
        ...
        if isinstance(inner_exception, AssertionError):
...
class SuperCommand(Command):
    """An openchange-tool command with subcommands."""
...
class CommandError(Exception):
    """An exception class for openchange-tool Command errors."""
