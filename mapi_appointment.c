...
zval *create_appointment_object(zval *folder, mapi_object_t *message, mapi_id_t id TSRMLS_DC)
{
	return create_message_object("mapiappointment", folder, message, id TSRMLS_CC);
}
