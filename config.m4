...
if test "$PHP_MAPI" = "yes"; then
  ...
  PHP_NEW_EXTENSION(mapi, mapi.c mapi_profile_db.c mapi_profile.c mapi_session.c mapi_mailbox.c mapi_folder.c mapi_message.c mapi_contact.c mapi_table.c mapi_message_table.c  mapi_task.c ../utils/openchange-tools.c, $ext_shared)
fi
