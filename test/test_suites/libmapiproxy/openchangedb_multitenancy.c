...
START_TEST (test_get_SystemFolderID) {
	...
	ret = openchangedb_get_SystemFolderID(oc_ctx, USER1, 2, &folder_id);
	CHECK_SUCCESS;
	ck_assert_int_eq(folder_id, 17510839776146620417ul);

	ret = openchangedb_get_SystemFolderID(oc_ctx, USER1, 14, &folder_id);
	CHECK_SUCCESS;
	...
	ret = openchangedb_get_SystemFolderID(oc_ctx, USER1, 15, &folder_id);
	CHECK_SUCCESS;
	ck_assert_int_eq(folder_id, 1125899906842625ul);

	ret = openchangedb_get_SystemFolderID(oc_ctx, USER2, 15, &folder_id);
	CHECK_SUCCESS;
...
START_TEST (test_get_SpecialFolderID) {
	...
	ret = openchangedb_get_SpecialFolderID(oc_ctx, USER1, 2, &folder_id);
	CHECK_SUCCESS;
	ck_assert_int_eq(folder_id, 289356276058554369);

	ret = openchangedb_get_SpecialFolderID(oc_ctx, USER1, 5, &folder_id);
	CHECK_SUCCESS;
	ck_assert_int_eq(folder_id, 505529058172338177);

	ret = openchangedb_get_SpecialFolderID(oc_ctx, USER2, 5, &folder_id);
	CHECK_SUCCESS;
	ck_assert_int_eq(folder_id, 605529058172338177);

	ret = openchangedb_get_SpecialFolderID(oc_ctx, USER1, 6, &folder_id);
	CHECK_FAILURE;
} END_TEST
...
START_TEST (test_get_PublicFolderID) {
	...
	ret = openchangedb_get_PublicFolderID(oc_ctx, USER1, 14, &folder_id);
	CHECK_FAILURE;

	ret = openchangedb_get_PublicFolderID(oc_ctx, USER1, 5, &folder_id);
	CHECK_SUCCESS;
	ck_assert_int_eq(folder_id, 504403158265495553);

	ret = openchangedb_get_PublicFolderID(oc_ctx, USER2, 5, &folder_id);
	CHECK_SUCCESS;
	ck_assert_int_eq(folder_id, 720575940379279361);

	ret = openchangedb_get_PublicFolderID(oc_ctx, USER1, 6, &folder_id);
	CHECK_SUCCESS;
...
START_TEST (test_get_MailboxReplica) {
	struct GUID *repl = talloc_zero(mem_ctx, struct GUID);
	struct GUID *expected_repl = talloc_zero(mem_ctx, struct GUID);
	uint16_t *repl_id = talloc_zero(mem_ctx, uint16_t);

	ret = openchangedb_get_MailboxReplica(oc_ctx, USER1, repl_id, repl);
	CHECK_SUCCESS;
	...
	ret = openchangedb_get_MailboxReplica(oc_ctx, USER2, repl_id, repl);
	CHECK_SUCCESS;
...
START_TEST (test_get_PublicFolderReplica) {
	...
	ret = openchangedb_get_PublicFolderReplica(oc_ctx, USER1, repl_id, repl);
	CHECK_SUCCESS;
	GUID_from_string("c4898b91-da9d-4f3e-9ae4-8a8bd5051b89", expected_repl);
	ck_assert(GUID_equal(expected_repl, repl));
	ck_assert_int_eq(*repl_id, 1);

	ret = openchangedb_get_PublicFolderReplica(oc_ctx, USER2, repl_id, repl);
	CHECK_SUCCESS;
...
START_TEST (test_get_mapistoreURI) {
	...
	ret = openchangedb_get_mapistoreURI(mem_ctx, oc_ctx, USER1,
	...
	fid = 145241087982698497ul;
	ret = openchangedb_get_mapistoreURI(mem_ctx, oc_ctx, USER2,
					    fid, &mapistoreURI, true);
	CHECK_SUCCESS;
...
START_TEST (test_set_mapistoreURI) {
	...
	// User1
	ret = openchangedb_get_mapistoreURI(mem_ctx, oc_ctx, USER1, fid, &uri, true);
	CHECK_SUCCESS;
	ck_assert_str_eq(uri, initial_uri);

	ret = openchangedb_set_mapistoreURI(oc_ctx, USER1, fid, "foobar");
	CHECK_SUCCESS;
	...
	ret = openchangedb_set_mapistoreURI(oc_ctx, USER1, fid, initial_uri);
	CHECK_SUCCESS;
	// User2
	char *initial_uri_2 = "sogo://"USER2URL":"USER2URL"@mail/folderA1/";
	ret = openchangedb_get_mapistoreURI(mem_ctx, oc_ctx, USER2, fid, &uri, true);
	CHECK_SUCCESS;
	ck_assert_str_eq(uri, initial_uri_2);

	ret = openchangedb_set_mapistoreURI(oc_ctx, USER2, fid, "foobar");
	CHECK_SUCCESS;
	...
	ret = openchangedb_set_mapistoreURI(oc_ctx, USER2, fid, initial_uri_2);
	CHECK_SUCCESS;
} END_TEST
...
START_TEST (test_get_parent_fid) {
	...
	ret = openchangedb_get_parent_fid(oc_ctx, USER1, fid, &pfid, true);
	CHECK_SUCCESS;
	ck_assert_int_eq(18231415716525899777ul, pfid);

	fid = 216172782113783809ul;
	ret = openchangedb_get_parent_fid(oc_ctx, USER1, fid, &pfid, false);
	CHECK_SUCCESS;
	...
	ret = openchangedb_get_parent_fid(oc_ctx, USER2, fid, &pfid, false);
	CHECK_SUCCESS;
	ck_assert_int_eq(216172782113783809ul, pfid);
} END_TEST
...
START_TEST (test_get_parent_fid_which_is_the_mailbox) {
	...
	ret = openchangedb_get_parent_fid(oc_ctx, USER2, fid, &pfid, true);
	CHECK_SUCCESS;
	ck_assert_int_eq(17438782182108692481ul, pfid);
} END_TEST
...
START_TEST (test_get_fid) {
	...
	uri = talloc_strdup(mem_ctx, "sogo://"USER1URL"@contacts/personal/");
	ret = openchangedb_get_fid(oc_ctx, uri, &fid);
	CHECK_SUCCESS;
	ck_assert_int_eq(fid, 289356276058554369ul);

	uri = talloc_strdup(mem_ctx, "sogo://"USER2URL"@contacts/personal/");
	ret = openchangedb_get_fid(oc_ctx, uri, &fid);
	CHECK_SUCCESS;
	ck_assert_int_eq(fid, 289356276058554369ul);
} END_TEST
...
START_TEST (test_get_MAPIStoreURIs) {
	...
	ret = openchangedb_get_MAPIStoreURIs(oc_ctx, USER1, mem_ctx, &uris);
	CHECK_SUCCESS;
	...
	ret = openchangedb_get_MAPIStoreURIs(oc_ctx, USER2, mem_ctx, &uris);
	CHECK_SUCCESS;
	ck_assert_int_eq(uris->cValues, 23);
...
START_TEST (test_get_ReceiveFolder) {
	...
	const char *explicit;
	// User1
	ret = openchangedb_get_ReceiveFolder(mem_ctx, oc_ctx, USER1,
	...
	fid = 0;
	ret = openchangedb_get_ReceiveFolder(mem_ctx, oc_ctx, USER1, "IPM",
					     &fid, &explicit);
	CHECK_SUCCESS;
	ck_assert_int_eq(fid, expected_fid);
	...
	fid = 0;
	ret = openchangedb_get_ReceiveFolder(mem_ctx, oc_ctx, USER1, "all",
					     &fid, &explicit);
	CHECK_SUCCESS;
	ck_assert_int_eq(fid, expected_fid);
	ck_assert_str_eq(explicit, "All");
	// User2
	ret = openchangedb_get_ReceiveFolder(mem_ctx, oc_ctx, USER2,
					     "Report.IPM", &fid, &explicit);
	CHECK_SUCCESS;
	ck_assert_int_eq(fid, expected_fid);
	ck_assert_str_eq(explicit, "Report.IPM");
	...
	fid = 0;
	ret = openchangedb_get_ReceiveFolder(mem_ctx, oc_ctx, USER2, "IPM",
					     &fid, &explicit);
	CHECK_SUCCESS;
	ck_assert_int_eq(fid, expected_fid);
	ck_assert_str_eq(explicit, "IPM");
	...
	fid = 0;
	ret = openchangedb_get_ReceiveFolder(mem_ctx, oc_ctx, USER2, "all",
					     &fid, &explicit);
	CHECK_SUCCESS;
	ck_assert_int_eq(fid, expected_fid);
	ck_assert_str_eq(explicit, "All");
...
START_TEST (test_get_TransportFolder) {
	uint64_t fid;
	ret = openchangedb_get_TransportFolder(oc_ctx, USER1, &fid);
	CHECK_SUCCESS;
	ck_assert_int_eq(fid, 18375530904601755649ul);

	ret = openchangedb_get_TransportFolder(oc_ctx, USER2, &fid);
	CHECK_SUCCESS;
	ck_assert_int_eq(fid, 18375530904601755649ul);
} END_TEST
...
START_TEST (test_get_Transport_folder_when_has_unusual_display_name) {
	...
	ret = openchangedb_set_folder_properties(oc_ctx, USER1, transport_fid, row);
	CHECK_SUCCESS;
	...
	ret = openchangedb_set_folder_properties(oc_ctx, USER2, transport_fid, row);
	CHECK_SUCCESS;
...
START_TEST (test_get_folder_count) {
	...
	ret = openchangedb_get_folder_count(oc_ctx, USER1, fid, &count);
	CHECK_SUCCESS;
	...
	fid = 17438782182108692481ul;
	ret = openchangedb_get_folder_count(oc_ctx, USER2, fid, &count);
	CHECK_SUCCESS;
	ck_assert_int_eq(count, 12);
} END_TEST
...
START_TEST (test_get_folder_count_public_folder) {
	...
	ret = openchangedb_get_folder_count(oc_ctx, USER1,
	...
	ret = openchangedb_get_folder_count(oc_ctx, USER2,
					    216172782113783809ul, &count);
	CHECK_SUCCESS;
	ck_assert_int_eq(count, 4);
...
START_TEST (test_get_new_changeNumber) {
	...
	for (i = 0; i < 5; i++) {
		ret = openchangedb_get_new_changeNumber(oc_ctx, USER2, &cn);
		CHECK_SUCCESS;
		new_cn = ((exchange_globcnt(NEXT_CHANGE_NUMBER+i) << 16) | 0x0001);
		ck_assert(cn == new_cn);
	}
...
START_TEST (test_get_new_changeNumbers) {
	...
	// User2
	ret = openchangedb_get_new_changeNumbers(oc_ctx, mem_ctx, USER2, 10, &cns);
	CHECK_SUCCESS;
	ck_assert_int_eq(10, cns->cValues);
	for (i = 0; i < 10; i++) {
		cn = ((exchange_globcnt(NEXT_CHANGE_NUMBER + 10 + i) << 16) | 0x0001);
...
START_TEST (test_get_next_changeNumber) {
	...
	for (i = 0; i < 5; i++) {
		...
		ret = openchangedb_get_next_changeNumber(oc_ctx, USER2, &next_cn);
		CHECK_SUCCESS;
		ret = openchangedb_get_new_changeNumber(oc_ctx, USER2, &new_cn);
		CHECK_SUCCESS;
		ck_assert(next_cn == new_cn);
	}
} END_TEST
...
START_TEST (test_get_folder_property) {
	...
	ret = openchangedb_get_folder_property(mem_ctx, oc_ctx, USER1, proptag,
					       fid, &data);
	CHECK_SUCCESS;
	...
	ret = openchangedb_get_folder_property(mem_ctx, oc_ctx, USER2, proptag,
					       fid, &data);
	CHECK_SUCCESS;
...
START_TEST (test_set_folder_properties) {
	...
	ret = openchangedb_set_folder_properties(oc_ctx, USER1, fid, row);
	CHECK_SUCCESS;
...
START_TEST (test_get_fid_by_name) {
	...
	ret = openchangedb_get_fid_by_name(oc_ctx, USER1, pfid, "A2", &fid);
	CHECK_SUCCESS;
	ck_assert(fid == 14052356737302790145ul);
	ret = openchangedb_get_fid_by_name(oc_ctx, USER2, pfid, "A2", &fid);
	CHECK_SUCCESS;
	ck_assert(fid == 14052356737302790145ul);

	pfid = 216172782113783809ul;
	ret = openchangedb_get_fid_by_name(oc_ctx, USER1, pfid, "EFORMS REGISTRY", &fid);
	CHECK_SUCCESS;
	ck_assert(fid == 288230376151711745ul);
	ret = openchangedb_get_fid_by_name(oc_ctx, USER2, pfid, "EFORMS REGISTRY", &fid);
	CHECK_SUCCESS;
	ck_assert(fid == 288230376151711745ul);
} END_TEST
...
START_TEST (test_get_mid_by_subject) {
	...
	ret = openchangedb_get_mid_by_subject(oc_ctx, USER1, pfid,
					      "Sample message on system folder",
					      true, &mid);
	CHECK_SUCCESS;
	ck_assert(mid == 2522015791327477762ul);

	ret = openchangedb_get_mid_by_subject(oc_ctx, USER2, pfid,
...
START_TEST (test_delete_folder) {
	...
	// User1
	ret = openchangedb_get_folder_count(oc_ctx, USER1, pfid, &count);
	CHECK_SUCCESS;
	ck_assert_int_eq(count, 15);

	ret = openchangedb_delete_folder(oc_ctx, USER1, fid);
	CHECK_SUCCESS;
	...
	// User2
	ret = openchangedb_get_folder_count(oc_ctx, USER2, pfid, &count);
	CHECK_SUCCESS;
	ck_assert_int_eq(count, 15);

	ret = openchangedb_delete_folder(oc_ctx, USER2, fid);
	CHECK_SUCCESS;
...
START_TEST (test_set_ReceiveFolder) {
	...
	ret = openchangedb_set_ReceiveFolder(oc_ctx, USER1, "trash1", fid_1);
	CHECK_SUCCESS;
	ret = openchangedb_set_ReceiveFolder(oc_ctx, USER1, "whatever", fid_1);
	CHECK_SUCCESS;
	ret = openchangedb_set_ReceiveFolder(oc_ctx, USER1, "trash2", fid_1);
	CHECK_SUCCESS;
	ret = openchangedb_set_ReceiveFolder(oc_ctx, USER2, "trash1", fid_1);
	CHECK_SUCCESS;
	ret = openchangedb_set_ReceiveFolder(oc_ctx, USER2, "whatever", fid_1);
	CHECK_SUCCESS;
	ret = openchangedb_set_ReceiveFolder(oc_ctx, USER2, "trash2", fid_1);
	CHECK_SUCCESS;
	...
	ret = openchangedb_set_ReceiveFolder(oc_ctx, USER1, "trash1", fid_2);
	CHECK_SUCCESS;
	ret = openchangedb_set_ReceiveFolder(oc_ctx, USER1, "whatever", fid_2);
	CHECK_SUCCESS;
	ret = openchangedb_set_ReceiveFolder(oc_ctx, USER1, "trash2", fid_2);
	CHECK_SUCCESS;
	ret = openchangedb_set_ReceiveFolder(oc_ctx, USER2, "trash1", fid_2);
	CHECK_SUCCESS;
	ret = openchangedb_set_ReceiveFolder(oc_ctx, USER2, "whatever", fid_2);
	CHECK_SUCCESS;
	ret = openchangedb_set_ReceiveFolder(oc_ctx, USER2, "trash2", fid_2);
	CHECK_SUCCESS;
...
START_TEST (test_create_mailbox) {
	...
	ret = openchangedb_create_mailbox(oc_ctx, "chuck", "foobar", "com",
...
START_TEST (test_create_folder) {
	...
	ret = openchangedb_get_folder_count(oc_ctx, USER1, pfid, &count);
	CHECK_SUCCESS;
	ret = openchangedb_get_folder_count(oc_ctx, USER2, pfid, &count_2);
	CHECK_SUCCESS;

	fid = 10524912329164849153ul;
	changenumber = 424242;
	ret = openchangedb_create_folder(oc_ctx, USER1, pfid, fid, changenumber,
					 "sogo://"USER1URL"@mail/folderOhlala", 100);
	CHECK_SUCCESS;
	ret = openchangedb_create_folder(oc_ctx, USER2, pfid, fid, changenumber,
					 "sogo://"USER2URL"@mail/folderOhlala", 100);
	CHECK_SUCCESS;

	ret = openchangedb_get_folder_count(oc_ctx, USER1, pfid, &count_after);
	CHECK_SUCCESS;
	ck_assert_int_eq(count + 1, count_after);
	ret = openchangedb_get_folder_count(oc_ctx, USER2, pfid, &count_2_after);
	CHECK_SUCCESS;
...
START_TEST (test_create_folder_without_mapistore_uri) {
	...
	changenumber = 424243;
	ret = openchangedb_create_folder(oc_ctx, USER1, pfid, fid, changenumber, NULL, 100);
	CHECK_SUCCESS;
	ret = openchangedb_create_folder(oc_ctx, USER2, pfid, fid, changenumber, NULL, 100);
	CHECK_SUCCESS;
...
START_TEST (test_create_folder_and_display_name) {
	...
	ret = openchangedb_set_folder_properties(oc_ctx, USER1, fid, row);
	CHECK_SUCCESS;
	ret = openchangedb_set_folder_properties(oc_ctx, USER2, fid, row);
	CHECK_SUCCESS;

	ret = openchangedb_get_fid_by_name(oc_ctx, USER1, pfid, "some name", &fid2);
	CHECK_SUCCESS;
	ck_assert_int_eq(fid2, fid);
	ret = openchangedb_get_fid_by_name(oc_ctx, USER2, pfid, "some name", &fid2);
	CHECK_SUCCESS;
	ck_assert_int_eq(fid2, fid);
} END_TEST
...
START_TEST (test_create_public_folder) {
	...
	fid = 42;
	changenumber = 4242;
	ret = openchangedb_create_folder(oc_ctx, USER1, pfid, fid, changenumber, NULL, 2);
	CHECK_SUCCESS;
	...
	fid = 42;
	changenumber = 4242;
	ret = openchangedb_create_folder(oc_ctx, USER2, pfid, fid, changenumber, NULL, 2);
	CHECK_SUCCESS;

	ret = openchangedb_get_folder_count(oc_ctx, USER2, pfid, &count_after);
	CHECK_SUCCESS;
	ck_assert_int_eq(count + 1, count_after);
} END_TEST
...
START_TEST (test_get_message_count) {
	...
	// User1
	ret = openchangedb_get_message_count(oc_ctx, USER1, fid, &count, false);
	CHECK_SUCCESS;
	ck_assert_int_eq(count, 1);

	ret = openchangedb_get_message_count(oc_ctx, USER1, fid, &count, true);
	CHECK_SUCCESS;
	ck_assert_int_eq(count, 0);

	// User2
	ret = openchangedb_get_message_count(oc_ctx, USER2, fid, &count, false);
	CHECK_SUCCESS;
	ck_assert_int_eq(count, 1);

	ret = openchangedb_get_message_count(oc_ctx, USER2, fid, &count, true);
	CHECK_SUCCESS;
	ck_assert_int_eq(count, 0);
} END_TEST
...
START_TEST (test_get_message_count_from_public_folder) {
	...
	ret = openchangedb_get_message_count(oc_ctx, USER1, 1, &count, false);
	CHECK_SUCCESS;
	ck_assert_int_eq(count, 0);
	...
	ret = openchangedb_get_message_count(oc_ctx, USER2, 1, &count, false);
	CHECK_SUCCESS;
	ck_assert_int_eq(count, 0);
...
START_TEST (test_get_system_idx) {
	...
	ret = openchangedb_get_system_idx(oc_ctx, USER1, fid, &system_idx);
	CHECK_SUCCESS;
	...
	ret = openchangedb_get_system_idx(oc_ctx, USER2, fid, &system_idx);
	CHECK_SUCCESS;
	ck_assert_int_eq(15, system_idx);
} END_TEST
...
START_TEST (test_create_and_edit_message) {
	...
	fid = 17438782182108692481ul;
	mid = 10;
	ret = openchangedb_message_create(mem_ctx, oc_ctx, USER1, mid, fid, false, &msg);
	CHECK_SUCCESS;
	ret = openchangedb_message_create(mem_ctx, oc_ctx, USER2, mid, fid, false, &msg_2);
	CHECK_SUCCESS;

	ret = openchangedb_message_save(oc_ctx, msg, 0);
	CHECK_SUCCESS;
	ret = openchangedb_message_save(oc_ctx, msg_2, 0);
	CHECK_SUCCESS;

	ret = openchangedb_message_open(mem_ctx, oc_ctx, USER1, mid, fid, &msg, NULL);
	CHECK_SUCCESS;
	ret = openchangedb_message_open(mem_ctx, oc_ctx, USER2, mid, fid, &msg_2, NULL);
	CHECK_SUCCESS;
	...
	ret = openchangedb_message_get_property(mem_ctx, oc_ctx, msg_2, prop, &data);
	CHECK_SUCCESS;
	ck_assert(fid == *(uint64_t *)data);
	...
	CHECK_SUCCESS;
	ret = openchangedb_message_set_properties(mem_ctx, oc_ctx, msg_2, &row);
	CHECK_SUCCESS;
	...
	ret = openchangedb_message_open(mem_ctx, oc_ctx, USER1, mid, fid, &msg, 0);
	CHECK_SUCCESS;
	ret = openchangedb_message_open(mem_ctx, oc_ctx, USER2, mid, fid, &msg_2, 0);
	CHECK_SUCCESS;
	prop = PidTagDisplayName;
	ret = openchangedb_message_get_property(mem_ctx, oc_ctx, msg, prop, &data);
	CHECK_SUCCESS;
...
START_TEST (test_create_and_edit_message_on_public_folder) {
	...
	fid = 648518346341351425ul;
	mid = 1234512345ul;
	ret = openchangedb_message_create(mem_ctx, oc_ctx, USER1, mid, fid, true, &msg);
	CHECK_SUCCESS;
	ret = openchangedb_message_create(mem_ctx, oc_ctx, USER2, mid, fid, true, &msg_2);
	CHECK_SUCCESS;
...
START_TEST (test_build_table_folders) {
	...
	fid = 17438782182108692481ul;
	ret = openchangedb_table_init(mem_ctx, oc_ctx, USER1, 1, fid, &table);
	CHECK_SUCCESS;
	ret = openchangedb_table_init(mem_ctx, oc_ctx, USER2, 1, fid, &table_2);
	CHECK_SUCCESS;
	prop = PidTagFolderId;
	for (i = 0; i < 13; i++) {
		CHECK_SUCCESS;
	...
	for (i = 0; i < 13; i++) {
		CHECK_SUCCESS;
		ret = openchangedb_table_get_property(mem_ctx, oc_ctx, table_2,
						      prop, i, false, &data);
	}
	ck_assert_int_eq(ret, MAPI_E_INVALID_OBJECT);
...
START_TEST (test_build_table_folders_with_restrictions) {
	...
	CHECK_SUCCESS;
	openchangedb_table_set_restrictions(oc_ctx, table_2, &res);
	CHECK_SUCCESS;
...
START_TEST (test_set_locale) {
	ck_assert(openchangedb_set_locale(oc_ctx, USER1, 0x1001));
	ck_assert(!openchangedb_set_locale(oc_ctx, USER1, 0x1001));
	ck_assert(openchangedb_set_locale(oc_ctx, USER2, 0x040c));
	ck_assert(openchangedb_set_locale(oc_ctx, USER2, 0x0422));
	ck_assert(!openchangedb_set_locale(oc_ctx, USER2, 0x0422));
} END_TEST
...
START_TEST (test_set_receive_folder_to_mailbox) {
	...
	ret = openchangedb_set_ReceiveFolder(oc_ctx, USER1, "IPC", mailbox_fid);
	CHECK_SUCCESS;

	ret = openchangedb_get_ReceiveFolder(mem_ctx, oc_ctx, USER1, "IPC", &fid, &explicit);
	CHECK_SUCCESS;
	...
	// User2
	ret = openchangedb_set_ReceiveFolder(oc_ctx, USER2, "IPC", mailbox_fid);
	CHECK_SUCCESS;

	ret = openchangedb_get_ReceiveFolder(mem_ctx, oc_ctx, USER2, "IPC", &fid, &explicit);
	CHECK_SUCCESS;
...
Suite *openchangedb_multitenancy_mysql_suite(void)
{
