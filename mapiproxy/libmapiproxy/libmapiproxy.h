...
enum MAPISTATUS openchangedb_get_parent_fid(struct openchangedb_context *, uint64_t, uint64_t *, bool);
enum MAPISTATUS openchangedb_get_MAPIStoreURIs(struct openchangedb_context *, const char *, TALLOC_CTX *, struct StringArrayW_r **);
enum MAPISTATUS openchangedb_get_mapistoreURI(TALLOC_CTX *, struct openchangedb_context *, uint64_t, char **, bool);
enum MAPISTATUS openchangedb_set_mapistoreURI(struct openchangedb_context *, uint64_t, const char *, bool);
...
enum MAPISTATUS openchangedb_set_folder_properties(struct openchangedb_context *, uint64_t, struct SRow *);
char *          openchangedb_set_folder_property_data(TALLOC_CTX *, struct SPropValue *);
enum MAPISTATUS openchangedb_get_folder_property(TALLOC_CTX *, struct openchangedb_context *, uint32_t, uint64_t, void **);
enum MAPISTATUS openchangedb_get_folder_count(struct openchangedb_context *, uint64_t, uint32_t *);
