...
struct mapistore_backend {
	...
	struct {
		...
		enum mapistore_error	(*delete_message)(void *, uint64_t, uint8_t);
	        ...
	        enum mapistore_error	(*move_folder)(void *, void *, uint64_t, const char *);
	        enum mapistore_error	(*copy_folder)(void *, void *, uint64_t, bool, const char *);
...
enum mapistore_error mapistore_folder_move_folder(struct mapistore_context *, uint32_t, void *, void *, uint64_t, const char *);
enum mapistore_error mapistore_folder_copy_folder(struct mapistore_context *, uint32_t, void *, void *, uint64_t, bool, const char *);
