...
static void __attribute__((unused)) oc_test_begin(void)
{
  const char *path;
...
static void __attribute__((unused)) oc_test_end(void)
{
...
static void __attribute__((unused)) oc_test_describe(const char *desc)
{
  if (gbl_oc_test.is_enabled == 0)
    return ;
...
static void __attribute__((unused)) oc_test_skip(int cn_ids)
{
  if (gbl_oc_test.is_enabled == 0)
    return ;
...
static void __attribute__((unused)) oc_test_next(int is_success, const char *file, int line, const char *reason)
{
  if (gbl_oc_test.is_enabled == 0)
    return ;
