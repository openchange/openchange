...
#define PidTag7BitDisplayName                                                PROP_TAG(PT_UNICODE   , 0x39FF)  /* 0x39FF001F */
#define PidTag7BitDisplayName_Error                                          PROP_TAG(PT_ERROR     , 0x39FF)  /* 0x39FF000A */
...
#define PidTagAddressBookIsMemberOfDistributionList                          PROP_TAG(PT_MV_STRING8, 0x8008)  /* 0x8008101E */
...
#define PidTagAddressBookMember                                              PROP_TAG(PT_MV_STRING8, 0x8009)  /* 0x8009101E */
...
#define PidTagAttributeSystem_Error                                          PROP_TAG(PT_ERROR     , 0x10F5)  /* 0x10F5000A */
...
#define PidTagChangeNotificationGuid                                         PROP_TAG(PT_CLSID     , 0x6637)  /* 0x66370048 */
#define PidTagChangeNotificationGuid_Error                                   PROP_TAG(PT_ERROR     , 0x6637)  /* 0x6637000A */
...
#define PidTagCnsetRead                                                      PROP_TAG(PT_BINARY    , 0x67D2)  /* 0x67D20102 */
#define PidTagCnsetRead_Error                                                PROP_TAG(PT_ERROR     , 0x67D2)  /* 0x67D2000A */
#define PidTagCnsetSeen                                                      PROP_TAG(PT_BINARY    , 0x6796)  /* 0x67960102 */
#define PidTagCnsetSeenFAI                                                   PROP_TAG(PT_BINARY    , 0x67DA)  /* 0x67DA0102 */
#define PidTagCnsetSeenFAI_Error                                             PROP_TAG(PT_ERROR     , 0x67DA)  /* 0x67DA000A */
#define PidTagCnsetSeen_Error                                                PROP_TAG(PT_ERROR     , 0x6796)  /* 0x6796000A */
...
#define PidTagConflictItems                                                  PROP_TAG(PT_MV_BINARY , 0x1098)  /* 0x10981102 */
#define PidTagConflictItems_Error                                            PROP_TAG(PT_ERROR     , 0x1098)  /* 0x1098000A */
...
#define PidTagContentFilterPhishingConfidenceLevel                           PROP_TAG(PT_LONG      , 0x4084)  /* 0x40840003 */
#define PidTagContentFilterPhishingConfidenceLevel_Error                     PROP_TAG(PT_ERROR     , 0x4084)  /* 0x4084000A */
...
#define PidTagCreatorSimpleDisplayName                                       PROP_TAG(PT_UNICODE   , 0x4038)  /* 0x4038001F */
#define PidTagCreatorSimpleDisplayName_Error                                 PROP_TAG(PT_ERROR     , 0x4038)  /* 0x4038000A */
...
#define PidTagEcWarning                                                      PROP_TAG(PT_LONG      , 0x400F)  /* 0x400F0003 */
#define PidTagEcWarning_Error                                                PROP_TAG(PT_ERROR     , 0x400F)  /* 0x400F000A */
...
#define PidTagEndAttach                                                      PROP_TAG(PT_LONG      , 0x400E)  /* 0x400E0003 */
#define PidTagEndAttach_Error                                                PROP_TAG(PT_ERROR     , 0x400E)  /* 0x400E000A */
#define PidTagEndDate                                                        PROP_TAG(PT_SYSTIME   , 0x0061)  /* 0x00610040 */
#define PidTagEndDate_Error                                                  PROP_TAG(PT_ERROR     , 0x0061)  /* 0x0061000A */
#define PidTagEndEmbed                                                       PROP_TAG(PT_LONG      , 0x4002)  /* 0x40020003 */
#define PidTagEndEmbed_Error                                                 PROP_TAG(PT_ERROR     , 0x4002)  /* 0x4002000A */
#define PidTagEndFolder                                                      PROP_TAG(PT_LONG      , 0x400B)  /* 0x400B0003 */
#define PidTagEndFolder_Error                                                PROP_TAG(PT_ERROR     , 0x400B)  /* 0x400B000A */
#define PidTagEndMessage                                                     PROP_TAG(PT_LONG      , 0x400D)  /* 0x400D0003 */
#define PidTagEndMessage_Error                                               PROP_TAG(PT_ERROR     , 0x400D)  /* 0x400D000A */
#define PidTagEndToRecip                                                     PROP_TAG(PT_LONG      , 0x4004)  /* 0x40040003 */
#define PidTagEndToRecip_Error                                               PROP_TAG(PT_ERROR     , 0x4004)  /* 0x4004000A */
...
#define PidTagFXDelProp                                                      PROP_TAG(PT_LONG      , 0x4016)  /* 0x40160003 */
#define PidTagFXDelProp_Error                                                PROP_TAG(PT_ERROR     , 0x4016)  /* 0x4016000A */
#define PidTagFXErrorInfo                                                    PROP_TAG(PT_LONG      , 0x4018)  /* 0x40180003 */
#define PidTagFXErrorInfo_Error                                              PROP_TAG(PT_ERROR     , 0x4018)  /* 0x4018000A */
...
#define PidTagIdsetDeleted                                                   PROP_TAG(PT_BINARY    , 0x67E5)  /* 0x67E50102 */
#define PidTagIdsetDeleted_Error                                             PROP_TAG(PT_ERROR     , 0x67E5)  /* 0x67E5000A */
#define PidTagIdsetExpired                                                   PROP_TAG(PT_BINARY    , 0x6793)  /* 0x67930102 */
#define PidTagIdsetExpired_Error                                             PROP_TAG(PT_ERROR     , 0x6793)  /* 0x6793000A */
#define PidTagIdsetGiven                                                     PROP_TAG(PT_LONG      , 0x4017)  /* 0x40170003 */
#define PidTagIdsetGiven_Error                                               PROP_TAG(PT_ERROR     , 0x4017)  /* 0x4017000A */
#define PidTagIdsetNoLongerInScope                                           PROP_TAG(PT_BINARY    , 0x4021)  /* 0x40210102 */
#define PidTagIdsetNoLongerInScope_Error                                     PROP_TAG(PT_ERROR     , 0x4021)  /* 0x4021000A */
#define PidTagIdsetRead                                                      PROP_TAG(PT_BINARY    , 0x402D)  /* 0x402D0102 */
#define PidTagIdsetRead_Error                                                PROP_TAG(PT_ERROR     , 0x402D)  /* 0x402D000A */
#define PidTagIdsetUnread                                                    PROP_TAG(PT_BINARY    , 0x402E)  /* 0x402E0102 */
#define PidTagIdsetUnread_Error                                              PROP_TAG(PT_ERROR     , 0x402E)  /* 0x402E000A */
#define PidTagImapCachedMsgsize                                              PROP_TAG(PT_BINARY    , 0x10F0)  /* 0x10F00102 */
#define PidTagImapCachedMsgsize_Error                                        PROP_TAG(PT_ERROR     , 0x10F0)  /* 0x10F0000A */
...
#define PidTagIncrSyncChg                                                    PROP_TAG(PT_LONG      , 0x4012)  /* 0x40120003 */
#define PidTagIncrSyncChgPartial                                             PROP_TAG(PT_LONG      , 0x407D)  /* 0x407D0003 */
#define PidTagIncrSyncChgPartial_Error                                       PROP_TAG(PT_ERROR     , 0x407D)  /* 0x407D000A */
#define PidTagIncrSyncChg_Error                                              PROP_TAG(PT_ERROR     , 0x4012)  /* 0x4012000A */
...
#define PidTagIncrSyncEnd                                                    PROP_TAG(PT_LONG      , 0x4014)  /* 0x40140003 */
#define PidTagIncrSyncEnd_Error                                              PROP_TAG(PT_ERROR     , 0x4014)  /* 0x4014000A */
#define PidTagIncrSyncGroupId                                                PROP_TAG(PT_LONG      , 0x407C)  /* 0x407C0003 */
#define PidTagIncrSyncGroupId_Error                                          PROP_TAG(PT_ERROR     , 0x407C)  /* 0x407C000A */
#define PidTagIncrSyncGroupInfo                                              PROP_TAG(PT_BINARY    , 0x407B)  /* 0x407B0102 */
#define PidTagIncrSyncGroupInfo_Error                                        PROP_TAG(PT_ERROR     , 0x407B)  /* 0x407B000A */
#define PidTagIncrSyncMessage                                                PROP_TAG(PT_LONG      , 0x4015)  /* 0x40150003 */
#define PidTagIncrSyncMessage_Error                                          PROP_TAG(PT_ERROR     , 0x4015)  /* 0x4015000A */
#define PidTagIncrSyncProgressMode                                           PROP_TAG(PT_BOOLEAN   , 0x4074)  /* 0x4074000B */
#define PidTagIncrSyncProgressMode_Error                                     PROP_TAG(PT_ERROR     , 0x4074)  /* 0x4074000A */
#define PidTagIncrSyncProgressPerMsg                                         PROP_TAG(PT_BOOLEAN   , 0x4075)  /* 0x4075000B */
#define PidTagIncrSyncProgressPerMsg_Error                                   PROP_TAG(PT_ERROR     , 0x4075)  /* 0x4075000A */
#define PidTagIncrSyncRead                                                   PROP_TAG(PT_LONG      , 0x402F)  /* 0x402F0003 */
#define PidTagIncrSyncRead_Error                                             PROP_TAG(PT_ERROR     , 0x402F)  /* 0x402F000A */
#define PidTagIncrSyncStateBegin                                             PROP_TAG(PT_LONG      , 0x403A)  /* 0x403A0003 */
#define PidTagIncrSyncStateBegin_Error                                       PROP_TAG(PT_ERROR     , 0x403A)  /* 0x403A000A */
#define PidTagIncrSyncStateEnd                                               PROP_TAG(PT_LONG      , 0x403B)  /* 0x403B0003 */
#define PidTagIncrSyncStateEnd_Error                                         PROP_TAG(PT_ERROR     , 0x403B)  /* 0x403B000A */
#define PidTagIncrementalSyncMessagePartial                                  PROP_TAG(PT_LONG      , 0x407A)  /* 0x407A0003 */
#define PidTagIncrementalSyncMessagePartial_Error                            PROP_TAG(PT_ERROR     , 0x407A)  /* 0x407A000A */
...
#define PidTagInternetArticleNumber                                          PROP_TAG(PT_LONG      , 0x0E23)  /* 0x0E230003 */
#define PidTagInternetArticleNumber_Error                                    PROP_TAG(PT_ERROR     , 0x0E23)  /* 0x0E23000A */
...
#define PidTagLastModifierSimpleDisplayName                                  PROP_TAG(PT_UNICODE   , 0x4039)  /* 0x4039001F */
#define PidTagLastModifierSimpleDisplayName_Error                            PROP_TAG(PT_ERROR     , 0x4039)  /* 0x4039000A */
...
#define PidTagMimeSkeleton                                                   PROP_TAG(PT_BINARY    , 0x0470)  /* 0x04700102 */
#define PidTagMimeSkeleton_Error                                             PROP_TAG(PT_ERROR     , 0x0470)  /* 0x0470000A */
...
#define PidTagNewAttach                                                      PROP_TAG(PT_LONG      , 0x4000)  /* 0x40000003 */
#define PidTagNewAttach_Error                                                PROP_TAG(PT_ERROR     , 0x4000)  /* 0x4000000A */
#define PidTagNewFXFolder                                                    PROP_TAG(PT_BINARY    , 0x4011)  /* 0x40110102 */
#define PidTagNewFXFolder_Error                                              PROP_TAG(PT_ERROR     , 0x4011)  /* 0x4011000A */
...
#define PidTagNormalMessageSize_Error                                        PROP_TAG(PT_ERROR     , 0x66B3)  /* 0x66B3000A */
...
#define PidTagOfflineAddressBookCompressedSize                               PROP_TAG(PT_LONG      , 0x6809)  /* 0x68090003 */
#define PidTagOfflineAddressBookCompressedSize_Error                         PROP_TAG(PT_ERROR     , 0x6809)  /* 0x6809000A */
...
#define PidTagOfflineAddressBookFileSize                                     PROP_TAG(PT_LONG      , 0x680A)  /* 0x680A0003 */
#define PidTagOfflineAddressBookFileSize_Error                               PROP_TAG(PT_ERROR     , 0x680A)  /* 0x680A000A */
#define PidTagOfflineAddressBookFileType                                     PROP_TAG(PT_LONG      , 0x6808)  /* 0x68080003 */
#define PidTagOfflineAddressBookFileType_Error                               PROP_TAG(PT_ERROR     , 0x6808)  /* 0x6808000A */
#define PidTagOfflineAddressBookLanguageId                                   PROP_TAG(PT_LONG      , 0x6807)  /* 0x68070003 */
#define PidTagOfflineAddressBookLanguageId_Error                             PROP_TAG(PT_ERROR     , 0x6807)  /* 0x6807000A */
...
#define PidTagOfflineAddressBookShaHash                                      PROP_TAG(PT_BINARY    , 0x6806)  /* 0x68060102 */
#define PidTagOfflineAddressBookShaHash_Error                                PROP_TAG(PT_ERROR     , 0x6806)  /* 0x6806000A */
...
#define PidTagOriginalDisplayName_Error                                      PROP_TAG(PT_ERROR     , 0x3A13)  /* 0x3A13000A */
...
#define PidTagOriginalSearchKey                                              PROP_TAG(PT_BINARY    , 0x3A14)  /* 0x3A140102 */
#define PidTagOriginalSearchKey_Error                                        PROP_TAG(PT_ERROR     , 0x3A14)  /* 0x3A14000A */
...
#define PidTagPrimarySmtpAddress                                             PROP_TAG(PT_UNICODE   , 0x39FE)  /* 0x39FE001F */
#define PidTagPrimarySmtpAddress_Error                                       PROP_TAG(PT_ERROR     , 0x39FE)  /* 0x39FE000A */
...
#define PidTagProviderSubmitTime                                             PROP_TAG(PT_SYSTIME   , 0x0048)  /* 0x00480040 */
#define PidTagProviderSubmitTime_Error                                       PROP_TAG(PT_ERROR     , 0x0048)  /* 0x0048000A */
#define PidTagPublicFolderAdministrativeDescription                          PROP_TAG(PT_UNICODE   , 0x671C)  /* 0x671C001F */
#define PidTagPublicFolderAdministrativeDescription_Error                    PROP_TAG(PT_ERROR     , 0x671C)  /* 0x671C000A */
#define PidTagPublicFolderProxy                                              PROP_TAG(PT_BINARY    , 0x671D)  /* 0x671D0102 */
#define PidTagPublicFolderProxy_Error                                        PROP_TAG(PT_ERROR     , 0x671D)  /* 0x671D000A */
...
#define PidTagReceivedByFlags_Error                                          PROP_TAG(PT_ERROR     , 0x401B)  /* 0x401B000A */
...
#define PidTagReceivedRepresentingFlags                                      PROP_TAG(PT_LONG      , 0x401C)  /* 0x401C0003 */
#define PidTagReceivedRepresentingFlags_Error                                PROP_TAG(PT_ERROR     , 0x401C)  /* 0x401C000A */
...
#define PidTagReceivedRepresentingSimpleDisplayName                          PROP_TAG(PT_UNICODE   , 0x4035)  /* 0x4035001F */
#define PidTagReceivedRepresentingSimpleDisplayName_Error                    PROP_TAG(PT_ERROR     , 0x4035)  /* 0x4035000A */
...
#define PidTagRecipientResourceState                                         PROP_TAG(PT_LONG      , 0x5FDE)  /* 0x5FDE0003 */
#define PidTagRecipientResourceState_Error                                   PROP_TAG(PT_ERROR     , 0x5FDE)  /* 0x5FDE000A */
...
#define PidTagRemoteHeaderLoc                                                PROP_TAG(PT_UNICODE   , 0x0078)  /* 0x0078001F */
#define PidTagRemoteHeaderLoc_Error                                          PROP_TAG(PT_ERROR     , 0x0078)  /* 0x0078000A */
...
#define PidTagRtfSyncBodyCount                                               PROP_TAG(PT_LONG      , 0x1007)  /* 0x10070003 */
#define PidTagRtfSyncBodyCount_Error                                         PROP_TAG(PT_ERROR     , 0x1007)  /* 0x1007000A */
#define PidTagRtfSyncBodyCrc                                                 PROP_TAG(PT_LONG      , 0x1006)  /* 0x10060003 */
#define PidTagRtfSyncBodyCrc_Error                                           PROP_TAG(PT_ERROR     , 0x1006)  /* 0x1006000A */
#define PidTagRtfSyncBodyTag                                                 PROP_TAG(PT_UNICODE   , 0x1008)  /* 0x1008001F */
#define PidTagRtfSyncBodyTag_Error                                           PROP_TAG(PT_ERROR     , 0x1008)  /* 0x1008000A */
#define PidTagRtfSyncPrefixCount                                             PROP_TAG(PT_LONG      , 0x1010)  /* 0x10100003 */
#define PidTagRtfSyncPrefixCount_Error                                       PROP_TAG(PT_ERROR     , 0x1010)  /* 0x1010000A */
#define PidTagRtfSyncTrailingCount                                           PROP_TAG(PT_LONG      , 0x1011)  /* 0x10110003 */
#define PidTagRtfSyncTrailingCount_Error                                     PROP_TAG(PT_ERROR     , 0x1011)  /* 0x1011000A */
...
#define PidTagSecureSubmitFlags                                              PROP_TAG(PT_LONG      , 0x65C6)  /* 0x65C60003 */
#define PidTagSecureSubmitFlags_Error                                        PROP_TAG(PT_ERROR     , 0x65C6)  /* 0x65C6000A */
#define PidTagSecurityDescriptor                                             PROP_TAG(PT_BINARY    , 0x0E27)  /* 0x0E270102 */
...
#define PidTagSecurityDescriptor_Error                                       PROP_TAG(PT_ERROR     , 0x0E27)  /* 0x0E27000A */
...
#define PidTagSenderFlags                                                    PROP_TAG(PT_LONG      , 0x4019)  /* 0x40190003 */
#define PidTagSenderFlags_Error                                              PROP_TAG(PT_ERROR     , 0x4019)  /* 0x4019000A */
...
#define PidTagSenderSimpleDisplayName                                        PROP_TAG(PT_UNICODE   , 0x4030)  /* 0x4030001F */
#define PidTagSenderSimpleDisplayName_Error                                  PROP_TAG(PT_ERROR     , 0x4030)  /* 0x4030000A */
...
#define PidTagSentRepresentingSimpleDisplayName                              PROP_TAG(PT_UNICODE   , 0x4031)  /* 0x4031001F */
#define PidTagSentRepresentingSimpleDisplayName_Error                        PROP_TAG(PT_ERROR     , 0x4031)  /* 0x4031000A */
#define PidTagSessionInitiationProtocolUri                                   PROP_TAG(PT_UNICODE   , 0x5FE5)  /* 0x5FE5001F */
#define PidTagSessionInitiationProtocolUri_Error                             PROP_TAG(PT_ERROR     , 0x5FE5)  /* 0x5FE5000A */
...
#define PidTagStartEmbed                                                     PROP_TAG(PT_LONG      , 0x4001)  /* 0x40010003 */
#define PidTagStartEmbed_Error                                               PROP_TAG(PT_ERROR     , 0x4001)  /* 0x4001000A */
#define PidTagStartFAIMsg                                                    PROP_TAG(PT_LONG      , 0x4010)  /* 0x40100003 */
#define PidTagStartFAIMsg_Error                                              PROP_TAG(PT_ERROR     , 0x4010)  /* 0x4010000A */
#define PidTagStartMessage                                                   PROP_TAG(PT_LONG      , 0x400C)  /* 0x400C0003 */
#define PidTagStartMessage_Error                                             PROP_TAG(PT_ERROR     , 0x400C)  /* 0x400C000A */
#define PidTagStartRecip                                                     PROP_TAG(PT_LONG      , 0x4003)  /* 0x40030003 */
#define PidTagStartRecip_Error                                               PROP_TAG(PT_ERROR     , 0x4003)  /* 0x4003000A */
#define PidTagStartSubFld                                                    PROP_TAG(PT_LONG      , 0x400A)  /* 0x400A0003 */
#define PidTagStartSubFld_Error                                              PROP_TAG(PT_ERROR     , 0x400A)  /* 0x400A000A */
#define PidTagStartTopFld                                                    PROP_TAG(PT_LONG      , 0x4009)  /* 0x40090003 */
#define PidTagStartTopFld_Error                                              PROP_TAG(PT_ERROR     , 0x4009)  /* 0x4009000A */
...
#define PidTagSubfolder                                                      PROP_TAG(PT_BOOLEAN   , 0x6708)  /* 0x6708000B */
#define PidTagSubfolder_Error                                                PROP_TAG(PT_ERROR     , 0x6708)  /* 0x6708000A */
...
#define PidTagTcvConstLongOne                                                PROP_TAG(PT_LONG      , 0x8008)  /* 0x80080003 */
#define PidTagTcvConstLongOne_Error                                          PROP_TAG(PT_ERROR     , 0x8008)  /* 0x8008000A */
...
#define PidTagTemporaryDefaultDocument                                       PROP_TAG(PT_UNICODE   , 0x3F20)  /* 0x3F20001F */
#define PidTagTemporaryDefaultDocument_Error                                 PROP_TAG(PT_ERROR     , 0x3F20)  /* 0x3F20000A */
...
#define PidTagTtyTddPhoneNumber                                              PROP_TAG(PT_UNICODE   , 0x3A4B)  /* 0x3A4B001F */
#define PidTagTtyTddPhoneNumber_Error                                        PROP_TAG(PT_ERROR     , 0x3A4B)  /* 0x3A4B000A */
...
#define PidTagUrlCompNameSet_Error                                           PROP_TAG(PT_ERROR     , 0x0E62)  /* 0x0E62000A */
#define PidTagUrlCompName_Error                                              PROP_TAG(PT_ERROR     , 0x10F3)  /* 0x10F3000A */
#define PidTagUrlName                                                        PROP_TAG(PT_UNICODE   , 0x6707)  /* 0x6707001F */
#define PidTagUrlName_Error                                                  PROP_TAG(PT_ERROR     , 0x6707)  /* 0x6707000A */
...
#define PidTagWlinkClientID                                                  PROP_TAG(PT_CLSID     , 0x6890)  /* 0x68900048 */
...
#define PidTagWlinkFolderType                                                PROP_TAG(PT_CLSID     , 0x684F)  /* 0x684F0048 */
#define PidTagWlinkFolderType_Error                                          PROP_TAG(PT_ERROR     , 0x684F)  /* 0x684F000A */
#define PidTagWlinkGroupClsid                                                PROP_TAG(PT_CLSID     , 0x6850)  /* 0x68500048 */
