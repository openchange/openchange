...
struct mapistore_backend {
	...
	/** context operations */
	struct {
		enum mapistore_error	(*get_path)(TALLOC_CTX *, void *, uint64_t, char **);
		...
		enum mapistore_error	(*create_message)(TALLOC_CTX *, void *, uint64_t, uint8_t, void **);
        ...
        /** oxcprpt operations */
        struct {
                enum mapistore_error	(*get_available_properties)(TALLOC_CTX *, void *, struct SPropTagArray **);
