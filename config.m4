...
PHP_MAPI_SRC="mapi.c mapi_profile_db.c mapi_profile.c  mapi_session.c mapi_mailbox.c  mapi_folder.c mapi_message.c  mapi_contact.c mapi_task.c  mapi_appointment.c  mapi_table.c mapi_message_table.c mapi_folder_table.c  php_mapi_constants.c "
