...
zval *create_contact_object(zval *folder, mapi_object_t *message, mapi_id_t id TSRMLS_DC)
{
	return create_message_object("mapicontact", folder, message, id TSRMLS_CC);
}
