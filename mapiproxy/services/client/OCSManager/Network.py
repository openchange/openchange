...
class Network(object):
    ...
    def __make_request(self, url=None, postfields=None, headers=None, data=None):
        ...
        """
        if data is None:
            return (True, 'Invalid StringIO buffer')
        if url is None:
    ...
    def __post(self, url=None, postfields=None, headers=None):
        ...
        """
        if postfields is None:
            return (True, 'Empty POST payload')
    ...
    def login(self, username=None, password=None, encryption=None):
        ...
        if password is None:
            return (True, 'Missing password parameter')
        if encryption is None:
            return (True, 'Missing encryption parameter')
