...
enum mapistore_error mapistore_backend_message_attachment_open_embedded_message(struct backend_context *, void *, enum OpenEmbeddedMessage_OpenModeFlags, TALLOC_CTX *, void **, uint64_t *, struct mapistore_message **msg);
